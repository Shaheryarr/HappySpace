...
import { SafeAreaView, ScrollView, Text, TextInput, TouchableOpacity, View, Dimensionsm, Image } from 'react-native';
                ...
                <ScrollView style={{ flex: 1 }}>
                    ...
                    {!image ? (
                        <View style={styles.uploadImageContainer}>
                            <TouchableOpacity style={styles.uploadImageIconContainer} onPress={handleCamera}>
                                <View style={styles.uploadImageIcon}>
                                    <Icon name={'camera'} size={25} style={styles.icon} />
                                </View>
                            </TouchableOpacity>

                            <TouchableOpacity style={styles.uploadImageIconContainer} onPress={handleGallery}>
                                <View style={styles.uploadImageIcon}>
